...
const PRODUCTION_INNGEST_URL = 'https://ai-server-production-production-8e2d.up.railway.app';

async function testInngestProduction() {
  console.log('🚀 Тестирование Instagram парсинга через Inngest в продакшене...\n');
  ...
  try {
    ...
    console.log(`   📊 Зарегистрировано функций: ${inngestInfo.data.function_count}`);
    ...
    console.log(`✅ ${inngestInfo.data.function_count} функций зарегистрировано`);
