  ...
  describe('Database Connection Tests', () => {
    ...
    it('should handle database timeouts gracefully', async () => {
      ...
      try {
        ...
        console.warn(
          'Connection was faster than expected - this is actually good!'
        )
      } catch (error: any) {
  ...
  describe('Project Manager Tests', () => {
    it('should create and retrieve project with retry logic', async () => {
      ...
      try {
        ...
        const { project: duplicateProject, created } =
          await projectManager.validateOrCreateProject(
            undefined,
            testTelegramId,
            testUsername,
  ...
  describe('Database Schema Tests', () => {
    it('should ensure projects table exists', async () => {
      ...
      try {
        ...
        if (!exists) {
          console.warn(
            'Projects table does not exist, this may be expected in some environments'
          )
        }
