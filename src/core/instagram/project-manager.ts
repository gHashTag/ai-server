...
export class ProjectManager {
   ...
   */
  async getOrCreateProject(input: CreateProjectInput): Promise<Project> {
    ...
    try {
      ...
      log.error('Error in getOrCreateProject:', error.message)
      throw error
    } finally {
      client.release()
    }
  ...
  async getProjectById(projectId: number): Promise<Project | null> {
    ...
    try {
      ...
      log.error('Error getting project by ID:', error.message)
      throw error
    } finally {
      client.release()
    }
