  ...
  try {
    const response = await openai.chat.completions.create({
      ...
      messages: [
        {
          role: 'system',
          content: 'Ты Любовь, DevOps с большим опытом. Говоришь тепло, заботливо, с пониманием и душой. Каждый анализ уникален. Не используешь шаблоны. Понимаешь систему как живой организм, который нуждается в заботе.'
        },
