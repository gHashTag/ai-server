...
class N8nRoute implements Routes {
  ...
  private initializeRoutes() {
    ...
    this.router.post(`${this.path}/trigger/:workflowName`, this.n8nController.triggerWorkflow);
    
    // Workflow management
    this.router.get(`${this.path}/workflows`, this.n8nController.getWorkflows);
    this.router.post(`${this.path}/workflows`, this.n8nController.createWorkflow);
    this.router.patch(`${this.path}/workflows/:workflowId/toggle`, this.n8nController.toggleWorkflow);
    
    // Execution management
    this.router.get(`${this.path}/executions/:executionId`, this.n8nController.getExecutionStatus);
