...
const mayExpenses = [
  ...
  },
  {
    ...
    description: 'Инструменты разработки',
    purpose:
      'Используется для автоматизации задач и улучшения функционала бота.',
    url: 'Cursor',
  },
  {
    date: '09/05',
  ...
  },
  {
    ...
    description: 'Генерация музыки',
    purpose:
      'Создание музыкального контента для улучшения взаимодействия с аудиторией.',
    url: 'Jammable',
  },
  {
    date: '18/05',
  ...
  },
  {
    ...
    description: 'AI API / ChatGPT',
    purpose:
      'Подписка на ChatGPT для генерации текстов и взаимодействия с пользователями.',
    url: 'OpenAI',
  },
  {
    date: '24/05',
