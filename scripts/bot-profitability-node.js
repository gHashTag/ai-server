...
function displayResults(stats) {
  ...
  sortedByIncome.forEach((bot, index) => {
    console.log(`${index + 1}. 🤖 ${bot.bot_name}: ${bot.total_rub_income.toFixed(2)} RUB + ${bot.total_stars_income} STARS (≈${bot.totalValue.toFixed(2)} RUB)`);
  });
}

async function main() {
  console.log('🚀 Начинаем анализ прибыльности ботов за май, июнь, июль 2025...');
